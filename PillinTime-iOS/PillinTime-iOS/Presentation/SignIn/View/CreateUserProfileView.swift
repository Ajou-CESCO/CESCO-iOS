...
struct CreateUserProfileView: View {
    ...
    private var isButtonDisabled: Bool {
        ...
        case 2:
            return !validationViewModel.infoErrorState.nameErrorMessage.isEmpty || validationViewModel.infoState.name.isEmpty
        case 3:
            return !validationViewModel.infoErrorState.ssnErrorMessage.isEmpty || validationViewModel.infoState.ssn.isEmpty
        default:
            return true
        }
    }
